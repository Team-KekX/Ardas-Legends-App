...
public class BattleServiceException extends LogicException {
    ...
    public static final String DEFENDING_ARMY_IS_MOVING = "Defending army is moving,which makes the movement of the attacking army to far!";
    ...
    public static BattleServiceException defendingArmyIsMoving (){return new BattleServiceException(DEFENDING_ARMY_IS_MOVING.formatted());}
