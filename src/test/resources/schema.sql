create table if not exists armies (id int8 generated by default as identity, army_type varchar(255) not null, created_at timestamp with time zone, free_tokens float8 not null, heal_end timestamp with time zone, heal_start timestamp with time zone, hours_healed int4, hours_left_healing int4, is_healing boolean, is_paid boolean, name varchar(255), current_region varchar(255) not null, faction int8 not null, origin_claimbuild int8, stationed_at int8, primary key (id));
