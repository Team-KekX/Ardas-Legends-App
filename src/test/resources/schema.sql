...
create table if not exists army_sieges (faction_id int8 not null, aliases varchar(255), army_id int8 not null, sieges varchar(255));
...
create table if not exists battles (id int8 generated by default as identity, agreed_battle_date timestamp, field_battle boolean, declared_date timestamp, name varchar(255), time_frozen_from timestamp, time_frozen_until timestamp, claim_build_id int8, region_id varchar(255), war_id int8, primary key (id));
create table if not exists claimbuild_application_production_sites (claimbuild_application_id int8 not null, count int8, production_site_id int8);
...
create table if not exists players (id int8 generated by default as identity, discord_id varchar(255) not null, ign varchar(255) not null, is_staff boolean, uuid varchar(255) not null, faction int8 not null, character_id int8, primary key (id));
...
create table if not exists roleplay_apps (id int8 generated by default as identity, version int4, applied_at timestamp not null, discord_accepted_message_link varchar(255), discord_application_message_link varchar(255) not null, last_vote_at timestamp not null, resolved_at timestamp, state varchar(255) not null, vote_count int2 not null, character_name varchar(255), character_title varchar(255), gear varchar(255), link_to_lore varchar(255), pvp boolean not null, why_do_you_want_to_be_this_character varchar(255), applicant_id int8 not null, faction_id int8 not null, primary key (id));
