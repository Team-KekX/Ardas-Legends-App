...
module.exports = {
    async execute(interaction) {
        ...
        let prodSites = interaction.options.getString('production-sites');
        let specialBuildings = interaction.options.getString('special-buildings');
        ...
        axios.post(`http://${serverIP}:${serverPort}/api/claimbuild/create`, data)
            .then(async function (response) {
                ...
                let prodSites = createProductionSiteString(claimbuild.productionSites);
                ...
                console.log("Faction:" +ownedBy)
                console.log("Region:" +claimbuild.region.id)
                console.log("Type:" +type)
                console.log("Prod:" +prodSites)
                ...
                var replyEmbed = new MessageEmbed()
                    ...
                    .addFields(
                        ...
                        {name: "Production Sites", value: prodSites, inline: false},
