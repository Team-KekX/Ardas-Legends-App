package com.ardaslegends.views.roleyplaydata;
...
@PageTitle("Roleyplay Data")
@Route(value = "roleyplay-data", layout = MainLayout.class)
@AnonymousAllowed
public class RoleyplayDataView extends Div {
    ...
    public RoleyplayDataView() {
        addClassName("roleyplay-data-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
