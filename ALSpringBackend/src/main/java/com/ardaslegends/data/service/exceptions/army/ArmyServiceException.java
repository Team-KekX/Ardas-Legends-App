...
public class ArmyServiceException extends ServiceException{
    ...
    public static ArmyServiceException claimbuildNotInTheSameOrAlliedFaction(ArmyType armyType, String claimbuildName) { return new ArmyServiceException(CLAIMBUILD_IS_NOT_IN_THE_SAME_OR_ALLIED_FACTION.formatted(claimbuildName, armyType.name())); }
    public static ArmyServiceException armyAlreadyStationed(ArmyType armyType, String armyName, String claimbuildName) { return new ArmyServiceException(ARMYTYPE_IS_ALREADY_STATIONED.formatted(armyType.name(), armyName, claimbuildName)); }
    ...
    public static ArmyServiceException notInSameRegion(ArmyType armyType, String armyName, String charName) { return new ArmyServiceException(NOT_IN_SAME_REGION.formatted(armyType.name(), armyName, charName)); }
    public static ArmyServiceException notSameFaction(ArmyType armyType, String armyName, String playerFactionName, String armyFactionName) { return new ArmyServiceException(NOT_SAME_FACTION.formatted(armyType.name(), armyName, playerFactionName, armyType.name(), armyFactionName)); }
    public static ArmyServiceException alreadyBound(ArmyType armyType, String armyName, String playerName) { return new ArmyServiceException(ALREADY_BOUND.formatted(armyType.name(), armyName, playerName)); }
    public static ArmyServiceException noPlayerBoundToArmy(ArmyType armyType, String armyName) { return new ArmyServiceException(NO_PLAYER_BOUND_TO_ARMYTYPE.formatted(armyType.name(), armyName)); }
    public static ArmyServiceException tooHighTokenCount(ArmyType armyType, int tokenCount) {return new ArmyServiceException(TOO_HIGH_TOKEN_COUNT.formatted(armyType.name(), tokenCount)); };
    public static ArmyServiceException maxArmyOrCompany(ArmyType armyType, String claimbuild, String units) {return new ArmyServiceException(MAX_ARMYTYPE_CREATED.formatted(claimbuild,armyType.name(), units)); }
    public static ArmyServiceException onlyLeaderCanBindWanderer(ArmyType armyType) {return new ArmyServiceException(ONLY_FACTION_LEADER_CAN_BIND_WANDERER.formatted(armyType.name()));}
    public static ArmyServiceException cannotMoveArmyDueToArmyBeingInMovement(ArmyType armyType, String armyName) {return new ArmyServiceException(CANNOT_MOVE_ARMYTYPE_DUE_TO_ALREADY_MOVING.formatted(armyType.name(), armyName));}
    public static ArmyServiceException cannotMoveArmyDueToPlayerAndArmyBeingInDifferentFactions(ArmyType armyType, String armyName) {return new ArmyServiceException(CANNOT_MOVE_ARMYTYPE_DUE_TO_PLAYER_AND_ARMY_BEING_IN_DIFFERENT_FACTIONS.formatted(armyType.name(), armyName)); }
    public static ArmyServiceException cannotMoveArmyAlreadyInRegion(ArmyType armyType, String armyName, String region) {return new ArmyServiceException(CANNOT_MOVE_ARMYTYPE_ALREADY_IN_REGION.formatted(armyType.name(), armyName,region));}
    public static ArmyServiceException cannotBindArmyIsMoving(ArmyType armyType, String armyName, String region) {return new ArmyServiceException((CANNOT_BIND_ARMYTYPE_IS_MOVING).formatted(armyType.name(), armyName, region));}
    public static ArmyServiceException cannotBindCharIsMoving(ArmyType armyType, String charName, String region) {return new ArmyServiceException((CANNOT_BIND_CHAR_IS_MOVING).formatted(charName, region, armyType.name()));}
    public static ArmyServiceException cannotCreateArmyFromClaimbuildInDifferentFaction(String playerFaction, String claimbuildFaction, ArmyType armyType) {return new ArmyServiceException((CANNOT_CREATE_ARMYTYPE_WHEN_IN_DIFFERENT_FACTIONS).formatted(playerFaction, claimbuildFaction, armyType.name()));}
    public static ArmyServiceException armyAndPlayerInDifferentFaction(ArmyType armyType, String playerFaction, String armyFaction) {return new ArmyServiceException(ARMYTYPE_AND_PLAYER_IN_DIFFERENT_FACTION.formatted(armyType.name(), playerFaction, armyFaction));}
    public static ArmyServiceException needToStationArmyAtCbWithHouseOfHealing(ArmyType armyType, String armyName) {return new ArmyServiceException(ARMYTYPE_MUST_BE_STATIONED_AT_A_CLAIMBUILD_WITH_HOUSE_OF_HEALING.formatted(armyType.name(), armyName, armyType.name()));}
    public static ArmyServiceException armyIsNotHealing(ArmyType armyType, String armyName) {return new ArmyServiceException((CANNOT_STOP_HEALING_IF_ARMYTYPE_IS_NOT_HEALING.formatted(armyType.name(), armyName)));}
    //Disband army
    public static ArmyServiceException notAllowedToDisbandNotSameFaction(ArmyType armyType, String armyName, String factionName) { return new ArmyServiceException(NOT_ALLOWED_TO_DISBAND_NOT_IN_SAME_FACTION.formatted(armyType.name(), armyName, factionName)); }
    public static ArmyServiceException notAllowedToDisband(ArmyType armyType) { return new ArmyServiceException(NOT_ALLOWED_TO_DISBAND.formatted(armyType.name())); }
    public static ArmyServiceException armyNotStationed(ArmyType armyType, String armyName) { return new ArmyServiceException((ARMYTYPE_IS_NOT_STATIONED.formatted(armyType.name(), armyName))); }
