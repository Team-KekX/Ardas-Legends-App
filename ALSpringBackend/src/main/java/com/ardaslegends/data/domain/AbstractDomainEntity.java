 ...
 */
public abstract sealed class AbstractDomainEntity permits Army, ClaimBuild, Faction, Player, ProductionClaimbuild, ProductionClaimbuildId, ProductionSite, Region, Unit, UnitType, RPChar {
}
